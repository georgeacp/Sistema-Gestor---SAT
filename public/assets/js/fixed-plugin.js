...
var fixedPluginButtonNav = document.querySelector("[fixed-plugin-button-nav={value.toString()}]");
var fixedPluginCard = document.querySelector("[fixed-plugin-card]");
var fixedPluginCloseButton = document.querySelector("[fixed-plugin-close-button]");

var navbar = document.querySelector("[navbar-main={value.toString()}]");
...
if (navbar) {
  ...
  const white_bg_elements = navbar.querySelectorAll("[sidenav-trigger={value.toString()}] i.bg-white");
